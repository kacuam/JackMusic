...
import com.example.jackmusic.StartMusicActivity;
...
import static com.example.jackmusic.util.Constants.URL_GET_MUSIC_ID;
import static com.example.jackmusic.util.Constants.URl_GET_MUSIC_LRC;
...
public class LrcUtil {
    ...
    private StartMusicActivity activity;
    public static Vector<Timelrc> lrclist; //ArrayList
    private boolean IsLyricExist = false;
    private int lastLine = 0;

    public LrcUtil(StartMusicActivity activityActivity) {
